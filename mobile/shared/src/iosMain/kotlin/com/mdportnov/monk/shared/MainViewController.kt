...
private val graph by lazy { MonkGraph(MonkStore(UserDefaultsStore()), IosPlatform) }

/** Entry point for the Swift shell. The UI renders, the blocker itself is a stub on iOS. */
fun MainViewController(): UIViewController = ComposeUIViewController { MonkApp(graph) }
